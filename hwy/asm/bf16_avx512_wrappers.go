...
//go:generate go tool goat ../c/ops_bf16_avx512_amd64.c -O3 -e="-mavx512bf16" -e="-mavx512f" -e="-mavx512vl"
...
// ============================================================================
// Assembly function declarations (generated by GoAT from ops_bf16_avx512_amd64.c)
// ============================================================================
...
// BFloat16 dot product with F32 accumulator

//go:noescape
func dot_bf16_avx512(a, b, acc, len unsafe.Pointer)

// BFloat16 arithmetic (via promote-compute-demote)
