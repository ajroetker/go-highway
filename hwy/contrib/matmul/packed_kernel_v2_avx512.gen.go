...
func BasePackedMicroKernel4x2_avx512_Float16(packedA []hwy.Float16, packedB []hwy.Float16, output []hwy.Float16, outputStride int, outRowStart int, outColStart int, panelK int, lanes int) {
	...
	p := 0
	for ; p+3 < panelK; p += 4 {
		bVec0_0 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx:])
		bVec1_0 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx+lanes:])
		...
		bVec0_1 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx+nr:])
		bVec1_1 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx+nr+lanes:])
		...
		bVec0_2 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx+2*nr:])
		bVec1_2 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx+2*nr+lanes:])
		...
		bVec0_3 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx+3*nr:])
		bVec1_3 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx+3*nr+lanes:])
	...
	for ; p < panelK; p++ {
		bVec0 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx:])
		bVec1 := asm.LoadFloat16x16AVX512Slice(packedB[bIdx+lanes:])
		bIdx += nr
...
func BasePackedMicroKernel4x2_avx512_BFloat16(packedA []hwy.BFloat16, packedB []hwy.BFloat16, output []hwy.BFloat16, outputStride int, outRowStart int, outColStart int, panelK int, lanes int) {
	...
	p := 0
	for ; p+3 < panelK; p += 4 {
		bVec0_0 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx:])
		bVec1_0 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx+lanes:])
		...
		acc30 = a3_0.MulAdd(bVec0_0, acc30)
		acc31 = a3_0.MulAdd(bVec1_0, acc31)
		bVec0_1 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx+nr:])
		bVec1_1 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx+nr+lanes:])
		...
		acc30 = a3_1.MulAdd(bVec0_1, acc30)
		acc31 = a3_1.MulAdd(bVec1_1, acc31)
		bVec0_2 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx+2*nr:])
		bVec1_2 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx+2*nr+lanes:])
		...
		acc30 = a3_2.MulAdd(bVec0_2, acc30)
		acc31 = a3_2.MulAdd(bVec1_2, acc31)
		bVec0_3 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx+3*nr:])
		bVec1_3 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx+3*nr+lanes:])
	...
	for ; p < panelK; p++ {
		bVec0 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx:])
		bVec1 := asm.LoadBFloat16x16AVX512Slice(packedB[bIdx+lanes:])
		bIdx += nr
