...
func BasePackLHSVec_avx512_Float16(a []hwy.Float16, packed []hwy.Float16, m int, k int, rowStart int, colStart int, panelRows int, panelK int, mr int) int {
	...
	for panel := 0; panel < fullPanels; panel++ {
		...
		for kk = 0; kk+lanes <= panelK; kk += lanes {
			r0 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&a[row0+kk]))
			r1 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&a[row1+kk]))
			r2 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&a[row2+kk]))
			r3 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&a[row3+kk]))
...
func BasePackLHSVec_avx512_BFloat16(a []hwy.BFloat16, packed []hwy.BFloat16, m int, k int, rowStart int, colStart int, panelRows int, panelK int, mr int) int {
	...
	for panel := 0; panel < fullPanels; panel++ {
		...
		var kk int
		for kk = 0; kk+lanes <= panelK; kk += lanes {
			r0 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&a[row0+kk]))
			r1 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&a[row1+kk]))
			r2 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&a[row2+kk]))
			r3 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&a[row3+kk]))
			t0 := r0.InterleaveLower(r2)
			t2 := r0.InterleaveUpper(r2)
			t1 := r1.InterleaveLower(r3)
			t3 := r1.InterleaveUpper(r3)
...
func BasePackLHSVec_avx512(a []float32, packed []float32, m int, k int, rowStart int, colStart int, panelRows int, panelK int, mr int) int {
	...
	for panel := 0; panel < fullPanels; panel++ {
		...
		var kk int
		for kk = 0; kk+lanes <= panelK; kk += lanes {
			r0 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&a[row0+kk])))
			r1 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&a[row1+kk])))
			r2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&a[row2+kk])))
			r3 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&a[row3+kk])))
			t0 := hwy.InterleaveLower_AVX512_F32x16(r0, r2)
			t2 := hwy.InterleaveUpper_AVX512_F32x16(r0, r2)
			t1 := hwy.InterleaveLower_AVX512_F32x16(r1, r3)
			t3 := hwy.InterleaveUpper_AVX512_F32x16(r1, r3)
			c0 := hwy.InterleaveLower_AVX512_F32x16(t0, t1)
			c1 := hwy.InterleaveUpper_AVX512_F32x16(t0, t1)
			c2 := hwy.InterleaveLower_AVX512_F32x16(t2, t3)
			c3 := hwy.InterleaveUpper_AVX512_F32x16(t2, t3)
			c0.StoreArray((*[16]float32)(unsafe.Pointer(&packed[packIdx])))
			c1.StoreArray((*[16]float32)(unsafe.Pointer(&packed[packIdx+lanes])))
			c2.StoreArray((*[16]float32)(unsafe.Pointer(&packed[packIdx+2*lanes])))
			c3.StoreArray((*[16]float32)(unsafe.Pointer(&packed[packIdx+3*lanes])))
			packIdx += lanes * mr
		}
		for ; kk < panelK; kk++ {
...
func BasePackLHSVec_avx512_Float64(a []float64, packed []float64, m int, k int, rowStart int, colStart int, panelRows int, panelK int, mr int) int {
	...
	for panel := 0; panel < fullPanels; panel++ {
		...
		var kk int
		for kk = 0; kk+lanes <= panelK; kk += lanes {
			r0 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&a[row0+kk])))
			r1 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&a[row1+kk])))
			r2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&a[row2+kk])))
			r3 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&a[row3+kk])))
			t0 := hwy.InterleaveLower_AVX512_F64x8(r0, r2)
			t2 := hwy.InterleaveUpper_AVX512_F64x8(r0, r2)
			t1 := hwy.InterleaveLower_AVX512_F64x8(r1, r3)
			t3 := hwy.InterleaveUpper_AVX512_F64x8(r1, r3)
			c0 := hwy.InterleaveLower_AVX512_F64x8(t0, t1)
			c1 := hwy.InterleaveUpper_AVX512_F64x8(t0, t1)
			c2 := hwy.InterleaveLower_AVX512_F64x8(t2, t3)
			c3 := hwy.InterleaveUpper_AVX512_F64x8(t2, t3)
			c0.StoreArray((*[8]float64)(unsafe.Pointer(&packed[packIdx])))
			c1.StoreArray((*[8]float64)(unsafe.Pointer(&packed[packIdx+lanes])))
			c2.StoreArray((*[8]float64)(unsafe.Pointer(&packed[packIdx+2*lanes])))
			c3.StoreArray((*[8]float64)(unsafe.Pointer(&packed[packIdx+3*lanes])))
			packIdx += lanes * mr
		}
		for ; kk < panelK; kk++ {
			packed[packIdx] = a[row0+kk]
...
func BasePackRHSVec_avx512_Float16(b []hwy.Float16, packed []hwy.Float16, n int, rowStart int, colStart int, panelK int, panelCols int, nr int) int {
	lanes := 16
		...
		if validCols == nr && nr >= lanes && nr%lanes == 0 {
			for kk := range panelK {
				...
				for c := 0; c < nr; c += lanes {
					v := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&b[srcRow+baseCol+c]))
...
func BasePackRHSVec_avx512_BFloat16(b []hwy.BFloat16, packed []hwy.BFloat16, n int, rowStart int, colStart int, panelK int, panelCols int, nr int) int {
	lanes := 16
	numMicroPanels := (panelCols + nr - 1) / nr
	activeColsLast := panelCols - (numMicroPanels-1)*nr
	dstIdx := 0
	for strip := 0; strip < panelCols; strip += nr {
		...
		if validCols == nr && nr >= lanes && nr%lanes == 0 {
			for kk := range panelK {
				srcRow := (rowStart + kk) * n
				for c := 0; c < nr; c += lanes {
					v := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&b[srcRow+baseCol+c]))
					v.StorePtr(unsafe.Pointer(&packed[dstIdx+c]))
				}
				dstIdx += nr
			}
...
func BasePackRHSVec_avx512(b []float32, packed []float32, n int, rowStart int, colStart int, panelK int, panelCols int, nr int) int {
	lanes := 16
	numMicroPanels := (panelCols + nr - 1) / nr
	activeColsLast := panelCols - (numMicroPanels-1)*nr
	dstIdx := 0
	for strip := 0; strip < panelCols; strip += nr {
		...
		if validCols == nr && nr >= lanes && nr%lanes == 0 {
			for kk := range panelK {
				srcRow := (rowStart + kk) * n
				for c := 0; c < nr; c += lanes {
					v := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&b[srcRow+baseCol+c])))
					v.StoreArray((*[16]float32)(unsafe.Pointer(&packed[dstIdx+c])))
				}
				dstIdx += nr
			}
			continue
...
func BasePackRHSVec_avx512_Float64(b []float64, packed []float64, n int, rowStart int, colStart int, panelK int, panelCols int, nr int) int {
	lanes := 8
	numMicroPanels := (panelCols + nr - 1) / nr
	activeColsLast := panelCols - (numMicroPanels-1)*nr
	dstIdx := 0
	for strip := 0; strip < panelCols; strip += nr {
		...
		if validCols == nr && nr >= lanes && nr%lanes == 0 {
			for kk := range panelK {
				srcRow := (rowStart + kk) * n
				for c := 0; c < nr; c += lanes {
					v := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&b[srcRow+baseCol+c])))
					v.StoreArray((*[8]float64)(unsafe.Pointer(&packed[dstIdx+c])))
				}
				dstIdx += nr
			}
			continue
