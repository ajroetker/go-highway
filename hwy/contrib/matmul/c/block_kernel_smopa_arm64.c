...
// SME SMOPA/SUMOPA Single-Tile Kernels for go-highway
// Compile with: -march=armv9-a+sme+sme-i16i64
//
// tile_smopa_s8: signed int8 × signed int8 → int32 outer product (SMOPA)
// tile_sumopa_s8u8: signed int8 × unsigned uint8 → int32 outer product (SUMOPA)
//
// Both use the same panel layout as tile_umopa_u8:
...
// tile_smopa_s8: signed × signed SMOPA
//
// func tile_smopa_s8(aPanel, bPanel unsafe.Pointer, c unsafe.Pointer, kGroups int64)
...
// tile_sumopa_s8u8: signed × unsigned SUMOPA
//
// func tile_sumopa_s8u8(aPanel, bPanel unsafe.Pointer, c unsafe.Pointer, kGroups int64)
void tile_sumopa_s8u8(signed char * restrict aPanel, unsigned char * restrict bPanel,
                      int * restrict c, long kGroups)
    __arm_streaming __arm_out("za") {
