...
void matmul_c_f32_neon(float *a, float *b, float *c, long *pm, long *pn, long *pk, long *plen_a, long *plen_b, long *plen_c) {
    long k = *pk;
    long len_a = *plen_a;
    long len_b = *plen_b;
    long len_c = *plen_c;
