...
TEXT ·packrhsvec_c_f64_neon(SB), $112-88
	MOVD b+0(FP), R0
	MOVD packed+8(FP), R1
	MOVD pn+16(FP), R2
...
BB0_4:
	...
	WORD $0x8b0c0c25   // add	x5, x1, x12, lsl #3
...
BB0_14:
	WORD $0xd2800018 // mov	x24, #0                         ; =0x0
	WORD $0x8b0c0dd9 // add	x25, x14, x12, lsl #3
	WORD $0xaa1703fe // mov	x30, x23

BB0_15:
	WORD $0xfc5e03c0 // ldur	d0, [x30, #-32]
	WORD $0xfc1e0320 // stur	d0, [x25, #-32]
	WORD $0xfc5e83c0 // ldur	d0, [x30, #-24]
	WORD $0xfc1e8320 // stur	d0, [x25, #-24]
	WORD $0xfc5f03c0 // ldur	d0, [x30, #-16]
	WORD $0xfc1f0320 // stur	d0, [x25, #-16]
	WORD $0xfc5f83c0 // ldur	d0, [x30, #-8]
	WORD $0xfc1f8320 // stur	d0, [x25, #-8]
	WORD $0xfd4003c0 // ldr	d0, [x30]
	WORD $0xfd000320 // str	d0, [x25]
	WORD $0xfd4007c0 // ldr	d0, [x30, #8]
	WORD $0xfd000720 // str	d0, [x25, #8]
	WORD $0xfd400bc0 // ldr	d0, [x30, #16]
	WORD $0xfd000b20 // str	d0, [x25, #16]
	WORD $0xfd400fc0 // ldr	d0, [x30, #24]
...
BB0_17:
	WORD $0x8b180ed8 // add	x24, x22, x24, lsl #3
...
BB0_20:
	WORD $0xf82c783f // str	xzr, [x1, x12, lsl #3]
	WORD $0x9100058c // add	x12, x12, #1
