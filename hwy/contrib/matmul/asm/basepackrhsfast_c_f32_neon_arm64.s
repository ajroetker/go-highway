...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/matmul/asm/basepackrhsfast_c_f32_neon_arm64.c

TEXT ·packrhsfast_c_f32_neon(SB), $80-80
	MOVD b+0(FP), R0
	MOVD packed+8(FP), R1
	MOVD pn+16(FP), R2
...
BB0_4:
	...
	WORD $0x8b0b0824 // add	x4, x1, x11, lsl #2
...
BB0_17:
	WORD $0x8b170ab7 // add	x23, x21, x23, lsl #2
...
BB0_20:
	WORD $0xb82b783f // str	wzr, [x1, x11, lsl #2]
	WORD $0x9100056b // add	x11, x11, #1
