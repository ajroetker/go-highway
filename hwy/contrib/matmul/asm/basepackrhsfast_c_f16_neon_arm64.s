...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/matmul/asm/basepackrhsfast_c_f16_neon_arm64.c

TEXT ·packrhsfast_c_f16_neon(SB), $80-80
	MOVD b+0(FP), R0
	MOVD packed+8(FP), R1
	MOVD pn+16(FP), R2
...
BB0_4:
	...
	WORD $0x8b0b0424   // add	x4, x1, x11, lsl #1
...
BB0_14:
	WORD $0xd2800017 // mov	x23, #0                         ; =0x0
	WORD $0x8b0b05b8 // add	x24, x13, x11, lsl #1
	WORD $0xaa1603f9 // mov	x25, x22

BB0_15:
	WORD $0x7c5f8321 // ldur	h1, [x25, #-8]
	WORD $0x7c1f8301 // stur	h1, [x24, #-8]
	WORD $0x7c5fa321 // ldur	h1, [x25, #-6]
	WORD $0x7c1fa301 // stur	h1, [x24, #-6]
	WORD $0x7c5fc321 // ldur	h1, [x25, #-4]
	WORD $0x7c1fc301 // stur	h1, [x24, #-4]
	WORD $0x7c5fe321 // ldur	h1, [x25, #-2]
	WORD $0x7c1fe301 // stur	h1, [x24, #-2]
	WORD $0x7d400321 // ldr	h1, [x25]
	WORD $0x7d000301 // str	h1, [x24]
	WORD $0x7d400721 // ldr	h1, [x25, #2]
	WORD $0x7d000701 // str	h1, [x24, #2]
	WORD $0x7d400b21 // ldr	h1, [x25, #4]
	WORD $0x7d000b01 // str	h1, [x24, #4]
	WORD $0x7d400f21 // ldr	h1, [x25, #6]
	WORD $0x7d000f01 // str	h1, [x24, #6]
...
BB0_17:
	WORD $0x8b1706b7 // add	x23, x21, x23, lsl #1
	WORD $0xaa0603f8 // mov	x24, x6

BB0_18:
	WORD $0x7c4026e1 // ldr	h1, [x23], #2
	WORD $0x7c2b7821 // str	h1, [x1, x11, lsl #1]
...
BB0_20:
	WORD $0x7c2b7820 // str	h0, [x1, x11, lsl #1]
	WORD $0x9100056b // add	x11, x11, #1
