...
TEXT ·matmul_c_f16_neon(SB), $64-72
	MOVD a+0(FP), R0
	MOVD b+8(FP), R1
	MOVD c+16(FP), R2
	MOVD pm+24(FP), R3
...
BB0_9:
	WORD $0x4ddfc713 // ld1r.8h	{ v19 }, [x24], #2
	WORD $0xad7f56f4 // ldp	q20, q21, [x23, #-32]
	WORD $0x4e530e90 // fmla.8h	v16, v20, v19
	WORD $0x4e530eb1 // fmla.8h	v17, v21, v19
	WORD $0xad4056f4 // ldp	q20, q21, [x23]
	WORD $0x4e530e92 // fmla.8h	v18, v20, v19
	WORD $0x4e530ea7 // fmla.8h	v7, v21, v19
	WORD $0x910006b5 // add	x21, x21, #1
	WORD $0x8b0d02f7 // add	x23, x23, x13
	WORD $0xeb1602bf // cmp	x21, x22
	BLT  BB0_9
	WORD $0x4e501463 // fadd.8h	v3, v3, v16
	WORD $0x4e511484 // fadd.8h	v4, v4, v17
	WORD $0x4e5214a5 // fadd.8h	v5, v5, v18
	WORD $0x91040294 // add	x20, x20, #256
	WORD $0x8b1000e7 // add	x7, x7, x16
	WORD $0x4e4714c6 // fadd.8h	v6, v6, v7
	WORD $0xeb0a027f // cmp	x19, x10
	BLT  BB0_8
	WORD $0x8b060466 // add	x6, x3, x6, lsl #1
	WORD $0xad0010c3 // stp	q3, q4, [x6]
...
BB0_12:
	WORD $0xb27d00b3 // orr	x19, x5, #0x8
...
BB0_14:
	WORD $0xf100015f // cmp	x10, #0
	BLE  BB0_24
	WORD $0x8b050426 // add	x6, x1, x5, lsl #1
...
BB0_18:
	WORD $0x7c4026e5 // ldr	h5, [x23], #2
	WORD $0x3dc00306 // ldr	q6, [x24]
	WORD $0x4f0510c4 // fmla.8h	v4, v6, v5[0]
	WORD $0x910006b5 // add	x21, x21, #1
	...
	WORD $0x3ca56863 // str	q3, [x3, x5]
	WORD $0x91002093 // add	x19, x4, #8
...
BB0_27:
	...
	WORD $0xf100015f // cmp	x10, #0
	BLE  BB0_35
	WORD $0x8b040425 // add	x5, x1, x4, lsl #1
...
BB0_32:
	WORD $0x7c4026c3 // ldr	h3, [x22], #2
	WORD $0x1ee24063 // fcvt	s3, h3
	WORD $0x7d4002e4 // ldr	h4, [x23]
	...
	WORD $0xeb0a00df // cmp	x6, x10
	BLT  BB0_31
	WORD $0x7c247861 // str	h1, [x3, x4, lsl #1]
...
BB0_35:
	WORD $0x8b040623 // add	x3, x17, x4, lsl #1
