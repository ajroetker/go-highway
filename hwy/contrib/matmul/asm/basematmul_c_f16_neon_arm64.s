...
BB0_8:
	WORD $0x4ddfc4c6 // ld1r.8h	{ v6 }, [x6], #2
	WORD $0xad7f40a7 // ldp	q7, q16, [x5, #-32]
	WORD $0x4e460ce2 // fmla.8h	v2, v7, v6
	WORD $0x4e460e03 // fmla.8h	v3, v16, v6
	WORD $0xad4040a7 // ldp	q7, q16, [x5]
...
BB0_15:
	WORD $0x7c667803 // ldr	h3, [x0, x6, lsl #1]
	WORD $0x3dc00084 // ldr	q4, [x4]
...
BB0_21:
	WORD $0xd37ffa23 // lsl	x3, x17, #1
	WORD $0xaa0403f1 // mov	x17, x4
	WORD $0x3ca36a00 // str	q0, [x16, x3]
	WORD $0x91002084 // add	x4, x4, #8
	WORD $0xeb0b009f // cmp	x4, x11
	BLE  BB0_21
	WORD $0xd1002091 // sub	x17, x4, #8
...
BB0_29:
	WORD $0x8b1105f0 // add	x16, x15, x17, lsl #1

BB0_30:
	WORD $0x7c002601 // str	h1, [x16], #2
