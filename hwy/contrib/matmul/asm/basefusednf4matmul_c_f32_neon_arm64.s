...
TEXT ·fusednf4matmul_c_f32_neon(SB), $131232-112
	MOVD input+0(FP), R0
	MOVD packed+8(FP), R1
...
BB0_13:
	...
	WORD $0xbc607aa1 // ldr	s1, [x21, x0, lsl #2]
	WORD $0xbc6c5a02 // ldr	s2, [x16, w12, uxtw #2]
	WORD $0x1e220821 // fmul	s1, s1, s2
	WORD $0xbc387961 // str	s1, [x11, x24, lsl #2]
	...
	WORD $0xad401b05 // ldp	q5, q6, [x24]
	WORD $0xad414307 // ldp	q7, q16, [x24, #32]
	...
	WORD $0xad001b05 // stp	q5, q6, [x24]
	WORD $0xad014307 // stp	q7, q16, [x24, #32]
...
BB0_17:
	...
	WORD $0x1e2508c1 // fmul	s1, s6, s5
	WORD $0x1e240862 // fmul	s2, s3, s4
...
BB0_19:
	...
	WORD $0xbc7879a3 // ldr	s3, [x13, x24, lsl #2]
	WORD $0x1e220821 // fmul	s1, s1, s2
	WORD $0x1f010c01 // fmadd	s1, s0, s1, s3
	WORD $0xbc3879a1 // str	s1, [x13, x24, lsl #2]
	WORD $0x91000718 // add	x24, x24, #1
