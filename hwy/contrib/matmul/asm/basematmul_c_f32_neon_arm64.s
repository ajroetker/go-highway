...
TEXT ·matmul_c_f32_neon(SB), $32-72
	MOVD a+0(FP), R0
	MOVD b+8(FP), R1
	MOVD c+16(FP), R2
	MOVD pm+24(FP), R3
...
BB0_8:
	WORD $0x4ddfc8e5 // ld1r.4s	{ v5 }, [x7], #4
	...
	BNE  BB0_8
	WORD $0x8b050a25 // add	x5, x17, x5, lsl #2
...
BB0_12:
	WORD $0xf100015f // cmp	x10, #0
	BLE  BB0_20
	WORD $0x8b040826 // add	x6, x1, x4, lsl #2
...
BB0_21:
	WORD $0x8b030a23 // add	x3, x17, x3, lsl #2
	WORD $0xa9007c7f // stp	xzr, xzr, [x3]
	WORD $0xaa0503e3 // mov	x3, x5
	WORD $0x910010a5 // add	x5, x5, #4
	WORD $0xeb0b00bf // cmp	x5, x11
	BLE  BB0_21
	WORD $0xd10010a3 // sub	x3, x5, #4
...
BB0_23:
	...
	WORD $0xf100015f // cmp	x10, #0
	BLE  BB0_29
	WORD $0x8b030824 // add	x4, x1, x3, lsl #2
...
BB0_29:
	WORD $0x8b030a11 // add	x17, x16, x3, lsl #2
