...
TEXT ·dequantizeiq4nl_c_f32_neon(SB), $64-32
	MOVD data+0(FP), R0
	MOVD output+8(FP), R1
...
BB0_3:
	...
	WORD $0x385fe12d // ldurb	w13, [x9, #-2]
	WORD $0x92400dad // and	x13, x13, #0xf
	WORD $0x385ff12e // ldurb	w14, [x9, #-1]
	WORD $0x92400dce // and	x14, x14, #0xf
	WORD $0x8b0e096e // add	x14, x11, x14, lsl #2
	WORD $0x3940012f // ldrb	w15, [x9]
	WORD $0x92400def // and	x15, x15, #0xf
	WORD $0x8b0f096f // add	x15, x11, x15, lsl #2
	WORD $0x39400530 // ldrb	w16, [x9, #1]
	WORD $0x92400e10 // and	x16, x16, #0xf
	...
	WORD $0x3940092d // ldrb	w13, [x9, #2]
	WORD $0x92400dad // and	x13, x13, #0xf
	WORD $0x39400d2e // ldrb	w14, [x9, #3]
	WORD $0x92400dce // and	x14, x14, #0xf
	WORD $0x8b0e096e // add	x14, x11, x14, lsl #2
	WORD $0x3940112f // ldrb	w15, [x9, #4]
	WORD $0x92400def // and	x15, x15, #0xf
	WORD $0x8b0f096f // add	x15, x11, x15, lsl #2
	WORD $0x39401530 // ldrb	w16, [x9, #5]
	WORD $0x92400e10 // and	x16, x16, #0xf
	WORD $0xbc6d7961 // ldr	s1, [x11, x13, lsl #2]
	WORD $0x0d4091c1 // ld1.s	{ v1 }[1], [x14]
	WORD $0x4d4081e1 // ld1.s	{ v1 }[2], [x15]
	...
	WORD $0x3940192d // ldrb	w13, [x9, #6]
	WORD $0x92400dad // and	x13, x13, #0xf
	WORD $0x39401d2e // ldrb	w14, [x9, #7]
	WORD $0x92400dce // and	x14, x14, #0xf
	WORD $0x8b0e096e // add	x14, x11, x14, lsl #2
	WORD $0x3940212f // ldrb	w15, [x9, #8]
	WORD $0x92400def // and	x15, x15, #0xf
	WORD $0x8b0f096f // add	x15, x11, x15, lsl #2
	WORD $0x39402530 // ldrb	w16, [x9, #9]
	WORD $0x92400e10 // and	x16, x16, #0xf
	WORD $0x8b100970 // add	x16, x11, x16, lsl #2
	WORD $0xbc6d7961 // ldr	s1, [x11, x13, lsl #2]
	WORD $0x0d4091c1 // ld1.s	{ v1 }[1], [x14]
