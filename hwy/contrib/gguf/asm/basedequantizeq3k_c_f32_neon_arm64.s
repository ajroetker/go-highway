...
TEXT ·dequantizeq3k_c_f32_neon(SB), $128-32
	MOVD data+0(FP), R0
	MOVD output+8(FP), R1
...
BB0_5:
	...
	WORD $0x2d4c95c7 // ldp	s7, s5, [x14, #100]
	WORD $0x2f08a4a5 // ushll.8h	v5, v5, #0
	WORD $0xbd4061c6 // ldr	s6, [x14, #96]
	WORD $0x2f08a4c6 // ushll.8h	v6, v6, #0
	WORD $0x0f1454b0 // shl.4h	v16, v5, #4
	WORD $0x0f1254b1 // shl.4h	v17, v5, #2
	WORD $0x2f1e04b2 // ushr.4h	v18, v5, #2
	WORD $0x2f0695e5 // bic.4h	v5, #207
	WORD $0x2f1c14c5 // usra.4h	v5, v6, #4
	WORD $0x2f079606 // bic.4h	v6, #240
	WORD $0x0e201e10 // and.8b	v16, v16, v0
	WORD $0x0ea61e06 // orr.8b	v6, v16, v6
	WORD $0x2f10a4c6 // ushll.4s	v6, v6, #0
	WORD $0x2f20a4d0 // ushll.2d	v16, v6, #0
	WORD $0x4e211e10 // and.16b	v16, v16, v1
	WORD $0x6f20a4c6 // ushll2.2d	v6, v6, #0
	WORD $0x4e211cc6 // and.16b	v6, v6, v1
	WORD $0xad001bf0 // stp	q16, q6, [sp]
	WORD $0x2f08a4e6 // ushll.8h	v6, v7, #0
	WORD $0x2f0095f2 // bic.4h	v18, #15
	WORD $0x2f1c14d2 // usra.4h	v18, v6, #4
	WORD $0x2f079606 // bic.4h	v6, #240
	WORD $0x0e201e27 // and.8b	v7, v17, v0
	...
	WORD $0x2f10a645 // ushll.4s	v5, v18, #0
	WORD $0x2f20a4a6 // ushll.2d	v6, v5, #0
	WORD $0x4e211cc6 // and.16b	v6, v6, v1
	WORD $0x6f20a4a5 // ushll2.2d	v5, v5, #0
	WORD $0x4e211ca5 // and.16b	v5, v5, v1
