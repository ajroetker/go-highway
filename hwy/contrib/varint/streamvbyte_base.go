...
//go:generate go run ../../../cmd/hwygen -input streamvbyte_base.go -output . -targets avx2,avx512,neon:asm,fallback -dispatch streamvbyte
...
func BaseEncodeStreamVByte32Group(values []uint32, dst []uint8) (ctrl byte, n int) {
