...
func _activationBaseAVX512InitHoistedConstants() {
	_activationBaseAVX512HoistOnce.Do(func() {
		...
		BaseELU_AVX512_vZero_f64 = archsimd.BroadcastFloat64x8(float64(actZero_f64))
		BaseGELUApprox_AVX512_vCoeff_f32 = archsimd.BroadcastFloat32x16(float32(actGeluApproxCoeff_f32))
		BaseGELUApprox_AVX512_vCoeff_f64 = archsimd.BroadcastFloat64x8(float64(actGeluApproxCoeff_f64))
		BaseGELU_AVX512_vHalf_f32 = archsimd.BroadcastFloat32x16(float32(actHalf_f32))
		BaseGELU_AVX512_vHalf_f64 = archsimd.BroadcastFloat64x8(float64(actHalf_f64))
		BaseGELU_AVX512_vInvSqrt2_f32 = archsimd.BroadcastFloat32x16(float32(actInvSqrt2_f32))
		BaseGELU_AVX512_vInvSqrt2_f64 = archsimd.BroadcastFloat64x8(float64(actInvSqrt2_f64))
		BaseGELU_AVX512_vOne_f32 = archsimd.BroadcastFloat32x16(float32(actOne_f32))
		BaseGELU_AVX512_vOne_f64 = archsimd.BroadcastFloat64x8(float64(actOne_f64))
		BaseHardSwish_AVX512_vBias_f32 = archsimd.BroadcastFloat32x16(float32(actHalf_f32))
		BaseHardSwish_AVX512_vBias_f64 = archsimd.BroadcastFloat64x8(float64(actHalf_f64))
		BaseHardSwish_AVX512_vOne_f32 = archsimd.BroadcastFloat32x16(float32(actOne_f32))
		BaseHardSwish_AVX512_vOne_f64 = archsimd.BroadcastFloat64x8(float64(actOne_f64))
		BaseHardSwish_AVX512_vScale_f32 = archsimd.BroadcastFloat32x16(float32(actHardSwishScale_f32))
		BaseHardSwish_AVX512_vScale_f64 = archsimd.BroadcastFloat64x8(float64(actHardSwishScale_f64))
		BaseHardSwish_AVX512_vZero_f32 = archsimd.BroadcastFloat32x16(float32(actZero_f32))
...
func BaseELU_avx512_Float16(input []hwy.Float16, output []hwy.Float16, alpha hwy.Float16) {
	...
	for ; ii+lanes*2 <= size; ii += lanes * 2 {
		x := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii]))
		expX := math.BaseExpVec_avx512_Float16(x)
		expM1 := expX.Sub(vOne)
		negPart := vAlpha.Mul(expM1)
		isPositive := x.Greater(vZero)
		result := x.Merge(negPart, isPositive)
		result.StorePtr(unsafe.Pointer(&output[ii]))
		x1 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii+16]))
		...
		result1.StorePtr(unsafe.Pointer(&output[ii+16]))
	}
...
func BaseELU_avx512_BFloat16(input []hwy.BFloat16, output []hwy.BFloat16, alpha hwy.BFloat16) {
	...
	ii := 0
	for ; ii+lanes*2 <= size; ii += lanes * 2 {
		x := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii]))
		...
		result := x.Merge(negPart, isPositive)
		result.StorePtr(unsafe.Pointer(&output[ii]))
		x1 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii+16]))
...
func BaseGELU_avx512_Float16(input []hwy.Float16, output []hwy.Float16) {
	...
	vHalf := asm.BroadcastFloat16x16AVX512(uint16(actHalf_f16))
	vOne := asm.BroadcastFloat16x16AVX512(uint16(actOne_f16))
	vInvSqrt2 := asm.BroadcastFloat16x16AVX512(uint16(actInvSqrt2_f16))
	lanes := 16
	ii := 0
	for ; ii+lanes*2 <= size; ii += lanes * 2 {
		x := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii]))
...
func BaseGELU_avx512_BFloat16(input []hwy.BFloat16, output []hwy.BFloat16) {
	...
	vHalf := asm.BroadcastBFloat16x16AVX512(uint16(actHalf_bf16))
	vOne := asm.BroadcastBFloat16x16AVX512(uint16(actOne_bf16))
	vInvSqrt2 := asm.BroadcastBFloat16x16AVX512(uint16(actInvSqrt2_bf16))
	lanes := 16
	ii := 0
	for ; ii+lanes*2 <= size; ii += lanes * 2 {
		x := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii]))
...
func BaseGELUApprox_avx512_Float16(input []hwy.Float16, output []hwy.Float16) {
	...
	vCoeff := asm.BroadcastFloat16x16AVX512(uint16(actGeluApproxCoeff_f16))
	lanes := 16
	ii := 0
	for ; ii+lanes*2 <= size; ii += lanes * 2 {
		x := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii]))
...
func BaseGELUApprox_avx512_BFloat16(input []hwy.BFloat16, output []hwy.BFloat16) {
	...
	vCoeff := asm.BroadcastBFloat16x16AVX512(uint16(actGeluApproxCoeff_bf16))
	lanes := 16
	ii := 0
	for ; ii+lanes*2 <= size; ii += lanes * 2 {
		x := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii]))
...
func BaseHardSwish_avx512_Float16(input []hwy.Float16, output []hwy.Float16) {
	...
	for ; ii+lanes*3 <= size; ii += lanes * 3 {
		...
		result1 := x1.Mul(s1)
		result1.StorePtr(unsafe.Pointer(&output[ii+16]))
		x2 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii+32]))
		s2 := x2.Mul(vScale).Add(vBias)
		s2 = s2.Max(vZero)
		s2 = s2.Min(vOne)
		result2 := x2.Mul(s2)
		result2.StorePtr(unsafe.Pointer(&output[ii+32]))
	}
	for ; ii+lanes <= size; ii += lanes {
		x := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii]))
		s := x.Mul(vScale).Add(vBias)
...
func BaseHardSwish_avx512_BFloat16(input []hwy.BFloat16, output []hwy.BFloat16) {
	...
	for ; ii+lanes*3 <= size; ii += lanes * 3 {
		...
		result1 := x1.Mul(s1)
		result1.StorePtr(unsafe.Pointer(&output[ii+16]))
		x2 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii+32]))
		s2 := x2.Mul(vScale).Add(vBias)
		s2 = s2.Max(vZero)
		s2 = s2.Min(vOne)
		result2 := x2.Mul(s2)
...
func BaseHardSwish_avx512(input []float32, output []float32) {
	...
	for ; ii+lanes*3 <= size; ii += lanes * 3 {
		...
		result1 := x1.Mul(s1)
		result1.StoreArray((*[16]float32)(unsafe.Pointer(&output[ii+16])))
		x2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&input[ii+32])))
		s2 := x2.Mul(vScale).Add(vBias)
		s2 = s2.Max(vZero)
		s2 = s2.Min(vOne)
		result2 := x2.Mul(s2)
		result2.StoreArray((*[16]float32)(unsafe.Pointer(&output[ii+32])))
	}
	for ; ii+lanes <= size; ii += lanes {
		x := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&input[ii])))
		s := x.Mul(vScale).Add(vBias)
...
func BaseHardSwish_avx512_Float64(input []float64, output []float64) {
	...
	for ; ii+lanes*3 <= size; ii += lanes * 3 {
		...
		result1 := x1.Mul(s1)
		result1.StoreArray((*[8]float64)(unsafe.Pointer(&output[ii+8])))
		x2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&input[ii+16])))
		s2 := x2.Mul(vScale).Add(vBias)
		s2 = s2.Max(vZero)
		s2 = s2.Min(vOne)
		result2 := x2.Mul(s2)
		result2.StoreArray((*[8]float64)(unsafe.Pointer(&output[ii+16])))
	}
	for ; ii+lanes <= size; ii += lanes {
		x := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&input[ii])))
		s := x.Mul(vScale).Add(vBias)
...
func BaseLeakyReLU_avx512_Float16(input []hwy.Float16, output []hwy.Float16, alpha hwy.Float16) {
	...
	for ; ii+lanes*4 <= size; ii += lanes * 4 {
		...
		result2.StorePtr(unsafe.Pointer(&output[ii+32]))
		x3 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii+48]))
		negPart3 := x3.Mul(vAlpha)
		result3 := x3.Max(negPart3)
		result3.StorePtr(unsafe.Pointer(&output[ii+48]))
	}
	for ; ii+lanes <= size; ii += lanes {
		x := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii]))
		negPart := x.Mul(vAlpha)
...
func BaseLeakyReLU_avx512_BFloat16(input []hwy.BFloat16, output []hwy.BFloat16, alpha hwy.BFloat16) {
	...
	for ; ii+lanes*4 <= size; ii += lanes * 4 {
		...
		result2 := x2.Max(negPart2)
		result2.StorePtr(unsafe.Pointer(&output[ii+32]))
		x3 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&input[ii+48]))
		negPart3 := x3.Mul(vAlpha)
		result3 := x3.Max(negPart3)
		result3.StorePtr(unsafe.Pointer(&output[ii+48]))
	}
...
func BaseLeakyReLU_avx512(input []float32, output []float32, alpha float32) {
	...
	for ; ii+lanes*4 <= size; ii += lanes * 4 {
		...
		result2 := x2.Max(negPart2)
		result2.StoreArray((*[16]float32)(unsafe.Pointer(&output[ii+32])))
		x3 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&input[ii+48])))
		negPart3 := x3.Mul(vAlpha)
		result3 := x3.Max(negPart3)
		result3.StoreArray((*[16]float32)(unsafe.Pointer(&output[ii+48])))
	}
	for ; ii+lanes <= size; ii += lanes {
		x := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&input[ii])))
		negPart := x.Mul(vAlpha)
...
func BaseLeakyReLU_avx512_Float64(input []float64, output []float64, alpha float64) {
	...
	for ; ii+lanes*4 <= size; ii += lanes * 4 {
		...
		result2 := x2.Max(negPart2)
		result2.StoreArray((*[8]float64)(unsafe.Pointer(&output[ii+16])))
		x3 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&input[ii+24])))
		negPart3 := x3.Mul(vAlpha)
		result3 := x3.Max(negPart3)
		result3.StoreArray((*[8]float64)(unsafe.Pointer(&output[ii+24])))
	}
	for ; ii+lanes <= size; ii += lanes {
		x := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&input[ii])))
		negPart := x.Mul(vAlpha)
