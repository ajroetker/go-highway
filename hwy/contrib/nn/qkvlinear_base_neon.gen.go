...
func BaseQKVLinear_neon_Float16(x []hwy.Float16, wQKV []hwy.Float16, biasQ []hwy.Float16, biasK []hwy.Float16, biasV []hwy.Float16, q []hwy.Float16, k []hwy.Float16, v []hwy.Float16, batchSize int, inFeatures int, qDim int, kvDim int) {
...
func BaseQKVLinear_neon_BFloat16(x []hwy.BFloat16, wQKV []hwy.BFloat16, biasQ []hwy.BFloat16, biasK []hwy.BFloat16, biasV []hwy.BFloat16, q []hwy.BFloat16, k []hwy.BFloat16, v []hwy.BFloat16, batchSize int, inFeatures int, qDim int, kvDim int) {
	totalOut := qDim + 2*kvDim
	if len(x) < batchSize*inFeatures {
		panic("qkvlinear: x slice too short")
	}
...
func BaseQKVLinear_neon(x []float32, wQKV []float32, biasQ []float32, biasK []float32, biasV []float32, q []float32, k []float32, v []float32, batchSize int, inFeatures int, qDim int, kvDim int) {
	totalOut := qDim + 2*kvDim
	if len(x) < batchSize*inFeatures {
		panic("qkvlinear: x slice too short")
	}
...
func BaseQKVLinear_neon_Float64(x []float64, wQKV []float64, biasQ []float64, biasK []float64, biasV []float64, q []float64, k []float64, v []float64, batchSize int, inFeatures int, qDim int, kvDim int) {
	totalOut := qDim + 2*kvDim
	if len(x) < batchSize*inFeatures {
		panic("qkvlinear: x slice too short")
	}
