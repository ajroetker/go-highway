...
func BaseLinear_fallback_Float16(x []hwy.Float16, weight []hwy.Float16, bias []hwy.Float16, output []hwy.Float16, batchSize int, inFeatures int, outFeatures int) {
...
func BaseLinear_fallback_BFloat16(x []hwy.BFloat16, weight []hwy.BFloat16, bias []hwy.BFloat16, output []hwy.BFloat16, batchSize int, inFeatures int, outFeatures int) {
	if len(x) < batchSize*inFeatures {
		panic("linear: x slice too short")
	}
	if len(weight) < outFeatures*inFeatures {
...
func BaseLinear_fallback(x []float32, weight []float32, bias []float32, output []float32, batchSize int, inFeatures int, outFeatures int) {
	if len(x) < batchSize*inFeatures {
		panic("linear: x slice too short")
	}
	if len(weight) < outFeatures*inFeatures {
...
func BaseLinear_fallback_Float64(x []float64, weight []float64, bias []float64, output []float64, batchSize int, inFeatures int, outFeatures int) {
	if len(x) < batchSize*inFeatures {
		panic("linear: x slice too short")
	}
	if len(weight) < outFeatures*inFeatures {
