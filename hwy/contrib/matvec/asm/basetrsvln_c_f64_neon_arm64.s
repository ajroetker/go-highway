...
TEXT ·trsvln_c_f64_neon(SB), $0-40
	MOVD l+0(FP), R0
	MOVD b+8(FP), R1
	MOVD pn+16(FP), R2
	...
	WORD $0x9280002b       // mov	x11, #-2                        ; =0xfffffffffffffffe
...
BB0_2:
	...
	WORD $0xfc6979a1 // ldr	d1, [x13, x9, lsl #3]
	WORD $0x1e611800 // fdiv	d0, d0, d1
	WORD $0xfc297820 // str	d0, [x1, x9, lsl #3]
...
BB0_5:
	WORD $0x927ff96d // and	x13, x11, #0xfffffffffffffffe
