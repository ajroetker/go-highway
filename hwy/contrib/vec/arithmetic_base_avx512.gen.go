...
func BaseAdd_avx512_Float16(dst []hwy.Float16, s []hwy.Float16) {
	...
	for ; i+lanes*4 <= n; i += lanes * 4 {
		vd := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i]))
		vs := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&s[i]))
		result := vd.Add(vs)
		result.StorePtr(unsafe.Pointer(&dst[i]))
		vd1 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+16]))
		vs1 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&s[i+16]))
		result1 := vd1.Add(vs1)
		result1.StorePtr(unsafe.Pointer(&dst[i+16]))
		vd2 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+32]))
		vs2 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&s[i+32]))
		result2 := vd2.Add(vs2)
		result2.StorePtr(unsafe.Pointer(&dst[i+32]))
		vd3 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+48]))
		vs3 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&s[i+48]))
		result3 := vd3.Add(vs3)
		result3.StorePtr(unsafe.Pointer(&dst[i+48]))
	}
	if i < n {
...
func BaseAdd_avx512_BFloat16(dst []hwy.BFloat16, s []hwy.BFloat16) {
	...
	i = 0
	for ; i+lanes*4 <= n; i += lanes * 4 {
		vd := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i]))
		vs := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&s[i]))
		result := vd.Add(vs)
		result.StorePtr(unsafe.Pointer(&dst[i]))
		vd1 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+16]))
		vs1 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&s[i+16]))
		result1 := vd1.Add(vs1)
		result1.StorePtr(unsafe.Pointer(&dst[i+16]))
		vd2 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+32]))
		vs2 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&s[i+32]))
		result2 := vd2.Add(vs2)
		result2.StorePtr(unsafe.Pointer(&dst[i+32]))
		vd3 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+48]))
		vs3 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&s[i+48]))
		result3 := vd3.Add(vs3)
		result3.StorePtr(unsafe.Pointer(&dst[i+48]))
	}
	if i < n {
...
func BaseAdd_avx512(dst []float32, s []float32) {
	...
	i = 0
	for ; i+lanes*4 <= n; i += lanes * 4 {
		vd := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&dst[i])))
		vs := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&s[i])))
		result := vd.Add(vs)
		result.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i])))
		vd1 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&dst[i+16])))
		vs1 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&s[i+16])))
		result1 := vd1.Add(vs1)
		result1.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+16])))
		vd2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&dst[i+32])))
		vs2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&s[i+32])))
		result2 := vd2.Add(vs2)
		result2.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+32])))
		vd3 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&dst[i+48])))
		vs3 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&s[i+48])))
		result3 := vd3.Add(vs3)
		result3.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+48])))
	}
	if i < n {
...
func BaseAdd_avx512_Float64(dst []float64, s []float64) {
	...
	i = 0
	for ; i+lanes*4 <= n; i += lanes * 4 {
		vd := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&dst[i])))
		vs := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&s[i])))
		result := vd.Add(vs)
		result.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i])))
		vd1 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&dst[i+8])))
		vs1 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&s[i+8])))
		result1 := vd1.Add(vs1)
		result1.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+8])))
		vd2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&dst[i+16])))
		vs2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&s[i+16])))
		result2 := vd2.Add(vs2)
		result2.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+16])))
		vd3 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&dst[i+24])))
		vs3 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&s[i+24])))
		result3 := vd3.Add(vs3)
		result3.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+24])))
	}
	if i < n {
...
func BaseAddTo_avx512_Float16(dst []hwy.Float16, a []hwy.Float16, b []hwy.Float16) {
	...
	i = 0
	for ; i+lanes*4 <= n; i += lanes * 4 {
		va := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&a[i]))
		vb := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&b[i]))
		result := va.Add(vb)
		result.StorePtr(unsafe.Pointer(&dst[i]))
		va1 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&a[i+16]))
		vb1 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&b[i+16]))
		result1 := va1.Add(vb1)
		result1.StorePtr(unsafe.Pointer(&dst[i+16]))
		va2 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&a[i+32]))
		vb2 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&b[i+32]))
		result2 := va2.Add(vb2)
		result2.StorePtr(unsafe.Pointer(&dst[i+32]))
		va3 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&a[i+48]))
		vb3 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&b[i+48]))
		result3 := va3.Add(vb3)
		result3.StorePtr(unsafe.Pointer(&dst[i+48]))
	}
	if i < n {
...
func BaseAddTo_avx512_BFloat16(dst []hwy.BFloat16, a []hwy.BFloat16, b []hwy.BFloat16) {
	...
	i = 0
	for ; i+lanes*4 <= n; i += lanes * 4 {
		va := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&a[i]))
		vb := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&b[i]))
		result := va.Add(vb)
		result.StorePtr(unsafe.Pointer(&dst[i]))
		va1 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&a[i+16]))
		vb1 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&b[i+16]))
		result1 := va1.Add(vb1)
		result1.StorePtr(unsafe.Pointer(&dst[i+16]))
		va2 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&a[i+32]))
		vb2 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&b[i+32]))
		result2 := va2.Add(vb2)
		result2.StorePtr(unsafe.Pointer(&dst[i+32]))
		va3 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&a[i+48]))
		vb3 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&b[i+48]))
		result3 := va3.Add(vb3)
		result3.StorePtr(unsafe.Pointer(&dst[i+48]))
	}
	if i < n {
...
func BaseAddTo_avx512(dst []float32, a []float32, b []float32) {
	...
	for ; i+lanes*4 <= n; i += lanes * 4 {
		...
		result := va.Add(vb)
		result.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i])))
		va1 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&a[i+16])))
		vb1 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&b[i+16])))
		result1 := va1.Add(vb1)
		result1.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+16])))
		va2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&a[i+32])))
		vb2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&b[i+32])))
		result2 := va2.Add(vb2)
		result2.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+32])))
		va3 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&a[i+48])))
		vb3 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&b[i+48])))
		result3 := va3.Add(vb3)
		result3.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+48])))
	}
	if i < n {
...
func BaseAddTo_avx512_Float64(dst []float64, a []float64, b []float64) {
	...
	for ; i+lanes*4 <= n; i += lanes * 4 {
		...
		result := va.Add(vb)
		result.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i])))
		va1 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&a[i+8])))
		vb1 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&b[i+8])))
		result1 := va1.Add(vb1)
		result1.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+8])))
		va2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&a[i+16])))
		vb2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&b[i+16])))
		result2 := va2.Add(vb2)
		result2.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+16])))
		va3 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&a[i+24])))
		vb3 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&b[i+24])))
		result3 := va3.Add(vb3)
		result3.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+24])))
	}
	if i < n {
...
func BaseMulConstAddTo_avx512_Float16(dst []hwy.Float16, a hwy.Float16, x []hwy.Float16) {
	...
	for ; i+lanes*4 <= n; i += lanes * 4 {
		vd := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i]))
		vx := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&x[i]))
		result := va.MulAdd(vx, vd)
		result.StorePtr(unsafe.Pointer(&dst[i]))
		vd1 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+16]))
		vx1 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&x[i+16]))
		result1 := va.MulAdd(vx1, vd1)
		result1.StorePtr(unsafe.Pointer(&dst[i+16]))
		vd2 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+32]))
		vx2 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&x[i+32]))
		result2 := va.MulAdd(vx2, vd2)
		result2.StorePtr(unsafe.Pointer(&dst[i+32]))
		vd3 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+48]))
		vx3 := asm.LoadFloat16x16AVX512Ptr(unsafe.Pointer(&x[i+48]))
...
func BaseMulConstAddTo_avx512_BFloat16(dst []hwy.BFloat16, a hwy.BFloat16, x []hwy.BFloat16) {
	...
	for ; i+lanes*4 <= n; i += lanes * 4 {
		vd := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i]))
		vx := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&x[i]))
		result := va.MulAdd(vx, vd)
		result.StorePtr(unsafe.Pointer(&dst[i]))
		vd1 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+16]))
		vx1 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&x[i+16]))
		result1 := va.MulAdd(vx1, vd1)
		result1.StorePtr(unsafe.Pointer(&dst[i+16]))
		vd2 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+32]))
		vx2 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&x[i+32]))
		result2 := va.MulAdd(vx2, vd2)
		result2.StorePtr(unsafe.Pointer(&dst[i+32]))
		vd3 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&dst[i+48]))
		vx3 := asm.LoadBFloat16x16AVX512Ptr(unsafe.Pointer(&x[i+48]))
		result3 := va.MulAdd(vx3, vd3)
		result3.StorePtr(unsafe.Pointer(&dst[i+48]))
	}
	if i < n {
...
func BaseMulConstAddTo_avx512(dst []float32, a float32, x []float32) {
	...
	for ; i+lanes*4 <= n; i += lanes * 4 {
		vd := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&dst[i])))
		vx := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&x[i])))
		result := va.MulAdd(vx, vd)
		result.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i])))
		vd1 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&dst[i+16])))
		vx1 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&x[i+16])))
		result1 := va.MulAdd(vx1, vd1)
		result1.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+16])))
		vd2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&dst[i+32])))
		vx2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&x[i+32])))
		result2 := va.MulAdd(vx2, vd2)
		result2.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+32])))
		vd3 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&dst[i+48])))
		vx3 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&x[i+48])))
		result3 := va.MulAdd(vx3, vd3)
		result3.StoreArray((*[16]float32)(unsafe.Pointer(&dst[i+48])))
	}
	for ; i < n; i++ {
...
func BaseMulConstAddTo_avx512_Float64(dst []float64, a float64, x []float64) {
	...
	for ; i+lanes*4 <= n; i += lanes * 4 {
		vd := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&dst[i])))
		vx := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&x[i])))
		result := va.MulAdd(vx, vd)
		result.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i])))
		vd1 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&dst[i+8])))
		vx1 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&x[i+8])))
		result1 := va.MulAdd(vx1, vd1)
		result1.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+8])))
		vd2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&dst[i+16])))
		vx2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&x[i+16])))
		result2 := va.MulAdd(vx2, vd2)
		result2.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+16])))
		vd3 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&dst[i+24])))
		vx3 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&x[i+24])))
		result3 := va.MulAdd(vx3, vd3)
		result3.StoreArray((*[8]float64)(unsafe.Pointer(&dst[i+24])))
	}
	for ; i < n; i++ {
