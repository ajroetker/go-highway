...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/vec/asm/baseargmin_c_f32_neon_arm64.c
...
TEXT ·argmin_c_f32_neon(SB), $0-24
	MOVD v+0(FP), R0
	MOVD plen_v+8(FP), R1
...
BB0_7:
	...
	WORD $0x6ea3e405 // fcmgt.4s	v5, v0, v3
...
BB0_20:
	...
	WORD $0xf100017f // cmp	x11, #0
	WORD $0x1e231408 // fccmp	s0, s3, #8, ne
	BMI  BB0_23
...
BB0_33:
	...
	WORD $0x1e202020 // fcmp	s1, s0
	WORD $0xfa405924 // ccmp	x9, #0, #4, pl
