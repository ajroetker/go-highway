...
TEXT ·argmax_c_bf16_neon(SB), $0-24
	MOVD v+0(FP), R0
	MOVD plen_v+8(FP), R1
...
BB0_5:
	...
	WORD $0x9a894149 // csel	x9, x10, x9, mi
	WORD $0x1e204c20 // fcsel	s0, s1, s0, mi
...
BB0_17:
	...
	WORD $0x6eb3e631 // fcmgt.4s	v17, v17, v19
	WORD $0x6eb2e4e7 // fcmgt.4s	v7, v7, v18
...
BB0_28:
	...
	WORD $0xf100017f // cmp	x11, #0
	WORD $0x1e231440 // fccmp	s2, s3, #0, ne
	BGT  BB0_31
	WORD $0x1e232040 // fcmp	s2, s3
	WORD $0xfa4c0124 // ccmp	x9, x12, #4, eq
	BGT  BB0_31
...
BB0_32:
	...
	WORD $0x7e21d800 // ucvtf	s0, s0
	WORD $0xf100017f // cmp	x11, #0
	WORD $0x1e201448 // fccmp	s2, s0, #8, ne
	BPL  BB0_34
...
BB0_34:
	...
	WORD $0x9a89b149 // csel	x9, x10, x9, lt
	WORD $0x1e22bc00 // fcsel	s0, s0, s2, lt
	WORD $0xb240014a // orr	x10, x10, #0x1
	WORD $0xeb08015f // cmp	x10, x8
	BNE  BB0_38
