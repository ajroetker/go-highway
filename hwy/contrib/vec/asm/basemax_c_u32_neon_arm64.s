...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/vec/asm/basemax_c_u32_neon_arm64.c

TEXT ·max_c_u32_neon(SB), $0-24
	MOVD v+0(FP), R0
	MOVD plen_v+8(FP), R1
	...
	WORD $0x1a898149            // csel	w9, w10, w9, hi
	WORD $0xf100091f            // cmp	x8, #2
	BEQ  BB0_6
	WORD $0xb9400808            // ldr	w8, [x0, #8]
	WORD $0x6b09011f            // cmp	w8, w9
	WORD $0x1a898109            // csel	w9, w8, w9, hi
