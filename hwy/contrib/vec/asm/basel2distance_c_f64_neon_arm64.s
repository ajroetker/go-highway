...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/vec/asm/basel2distance_c_f64_neon_arm64.c

TEXT ·l2distance_c_f64_neon(SB), $0-32
	MOVD a+0(FP), R0
	MOVD b+8(FP), R1
...
BB0_5:
	...
	WORD $0x4e75cea1 // fmla.2d	v1, v21, v21
	WORD $0x4e76cec2 // fmla.2d	v2, v22, v22
	WORD $0x4e64cc83 // fmla.2d	v3, v4, v4
...
BB0_8:
	...
	WORD $0x4ee4d463 // fsub.2d	v3, v3, v4
