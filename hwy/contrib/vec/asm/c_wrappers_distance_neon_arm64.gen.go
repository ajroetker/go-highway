...
// L2SquaredDistanceCBF16 computes L2SquaredDistance using NEON SIMD assembly.
func L2SquaredDistanceCBF16(a, b []hwy.BFloat16) hwy.BFloat16 {
	lenVal := int64(min(len(a), len(b)))
	if lenVal == 0 {
		return 0
	}
...
// L2SquaredDistanceCF32 computes L2SquaredDistance using NEON SIMD assembly.
func L2SquaredDistanceCF32(a, b []float32) float32 {
	lenVal := int64(min(len(a), len(b)))
	if lenVal == 0 {
		return 0
	}
...
// L2SquaredDistanceCF64 computes L2SquaredDistance using NEON SIMD assembly.
func L2SquaredDistanceCF64(a, b []float64) float64 {
	lenVal := int64(min(len(a), len(b)))
	if lenVal == 0 {
		return 0
	}
