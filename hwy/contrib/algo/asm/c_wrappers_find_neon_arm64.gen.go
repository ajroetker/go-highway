...
// ContainsCF32 computes Contains using NEON SIMD assembly.
func ContainsCF32(slice []float32, value float32) bool {
	if len(slice) == 0 {
		return false
	}
...
// ContainsCF64 computes Contains using NEON SIMD assembly.
func ContainsCF64(slice []float64, value float64) bool {
	if len(slice) == 0 {
		return false
	}
	var p_slice unsafe.Pointer
...
// ContainsCS32 computes Contains using NEON SIMD assembly.
func ContainsCS32(slice []int32, value int32) bool {
	if len(slice) == 0 {
		return false
	}
	var p_slice unsafe.Pointer
...
// ContainsCS64 computes Contains using NEON SIMD assembly.
func ContainsCS64(slice []int64, value int64) bool {
	if len(slice) == 0 {
		return false
	}
	var p_slice unsafe.Pointer
...
// ContainsCU32 computes Contains using NEON SIMD assembly.
func ContainsCU32(slice []uint32, value uint32) bool {
	if len(slice) == 0 {
		return false
	}
	var p_slice unsafe.Pointer
...
// ContainsCU64 computes Contains using NEON SIMD assembly.
func ContainsCU64(slice []uint64, value uint64) bool {
	if len(slice) == 0 {
		return false
	}
	var p_slice unsafe.Pointer
