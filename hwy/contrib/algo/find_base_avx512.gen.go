...
func BaseCount_avx512(slice []float32, value float32) int {
	...
	for ; i+lanes*3 <= n; i += lanes * 3 {
		v := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&slice[i])))
		mask := v.Equal(target)
		count += hwy.CountTrue_AVX512_F32x16(mask)
		v1 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&slice[i+16])))
		mask1 := v1.Equal(target)
		count += hwy.CountTrue_AVX512_F32x16(mask1)
		v2 := archsimd.LoadFloat32x16Array((*[16]float32)(unsafe.Pointer(&slice[i+32])))
...
func BaseCount_avx512_Float64(slice []float64, value float64) int {
	...
	i := 0
	for ; i+lanes*3 <= n; i += lanes * 3 {
		v := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&slice[i])))
		mask := v.Equal(target)
		count += hwy.CountTrue_AVX512_F64x8(mask)
		v1 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&slice[i+8])))
		mask1 := v1.Equal(target)
		count += hwy.CountTrue_AVX512_F64x8(mask1)
		v2 := archsimd.LoadFloat64x8Array((*[8]float64)(unsafe.Pointer(&slice[i+16])))
		mask2 := v2.Equal(target)
...
func BaseCount_avx512_Int32(slice []int32, value int32) int {
	...
	i := 0
	for ; i+lanes*3 <= n; i += lanes * 3 {
		v := archsimd.LoadInt32x16Array((*[16]int32)(unsafe.Pointer(&slice[i])))
		mask := v.Equal(target)
		count += hwy.CountTrue_AVX512_I32x16(mask)
		v1 := archsimd.LoadInt32x16Array((*[16]int32)(unsafe.Pointer(&slice[i+16])))
		mask1 := v1.Equal(target)
		count += hwy.CountTrue_AVX512_I32x16(mask1)
		v2 := archsimd.LoadInt32x16Array((*[16]int32)(unsafe.Pointer(&slice[i+32])))
		mask2 := v2.Equal(target)
...
func BaseCount_avx512_Int64(slice []int64, value int64) int {
	...
	i := 0
	for ; i+lanes*3 <= n; i += lanes * 3 {
		v := archsimd.LoadInt64x8Array((*[8]int64)(unsafe.Pointer(&slice[i])))
		mask := v.Equal(target)
		count += hwy.CountTrue_AVX512_I64x8(mask)
		v1 := archsimd.LoadInt64x8Array((*[8]int64)(unsafe.Pointer(&slice[i+8])))
		mask1 := v1.Equal(target)
		count += hwy.CountTrue_AVX512_I64x8(mask1)
		v2 := archsimd.LoadInt64x8Array((*[8]int64)(unsafe.Pointer(&slice[i+16])))
		mask2 := v2.Equal(target)
...
func BaseCount_avx512_Uint32(slice []uint32, value uint32) int {
	...
	i := 0
	for ; i+lanes*3 <= n; i += lanes * 3 {
		v := archsimd.LoadUint32x16Array((*[16]uint32)(unsafe.Pointer(&slice[i])))
		mask := v.Equal(target)
		count += hwy.CountTrue_AVX512_Uint32x16(mask)
		v1 := archsimd.LoadUint32x16Array((*[16]uint32)(unsafe.Pointer(&slice[i+16])))
		mask1 := v1.Equal(target)
		count += hwy.CountTrue_AVX512_Uint32x16(mask1)
		v2 := archsimd.LoadUint32x16Array((*[16]uint32)(unsafe.Pointer(&slice[i+32])))
		mask2 := v2.Equal(target)
...
func BaseCount_avx512_Uint64(slice []uint64, value uint64) int {
	...
	i := 0
	for ; i+lanes*3 <= n; i += lanes * 3 {
		v := archsimd.LoadUint64x8Array((*[8]uint64)(unsafe.Pointer(&slice[i])))
		mask := v.Equal(target)
		count += hwy.CountTrue_AVX512_Uint64x8(mask)
		v1 := archsimd.LoadUint64x8Array((*[8]uint64)(unsafe.Pointer(&slice[i+8])))
		mask1 := v1.Equal(target)
		count += hwy.CountTrue_AVX512_Uint64x8(mask1)
		v2 := archsimd.LoadUint64x8Array((*[8]uint64)(unsafe.Pointer(&slice[i+16])))
		mask2 := v2.Equal(target)
