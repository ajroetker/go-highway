...
func BasePrefixSum_avx512(data []float32) {
	...
	for ; i+lanes*3 <= n; i += lanes * 3 {
		...
		prefixed.StoreArray((*[16]float32)(unsafe.Pointer(&data[i])))
		...
		prefixed1.StoreArray((*[16]float32)(unsafe.Pointer(&data[i+16])))
		...
		prefixed2.StoreArray((*[16]float32)(unsafe.Pointer(&data[i+32])))
...
func BasePrefixSum_avx512_Float64(data []float64) {
	...
	for ; i+lanes*3 <= n; i += lanes * 3 {
		...
		prefixed.StoreArray((*[8]float64)(unsafe.Pointer(&data[i])))
		...
		prefixed1.StoreArray((*[8]float64)(unsafe.Pointer(&data[i+8])))
		...
		prefixed2.StoreArray((*[8]float64)(unsafe.Pointer(&data[i+16])))
