...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/roaring/asm/basepopcntorslice_c_u64_neon_arm64.c

TEXT ·popcntorslice_c_u64_neon(SB), $0-32
	MOVD s+0(FP), R0
	MOVD m+8(FP), R1
...
BB0_5:
	...
	WORD $0x4ea21e25 // orr.16b	v5, v17, v2
	WORD $0x4e2058a5 // cnt.16b	v5, v5
	WORD $0x6e2028a5 // uaddlp.8h	v5, v5
	WORD $0x6e6028a5 // uaddlp.4s	v5, v5
	WORD $0x6ea068a0 // uadalp.2d	v0, v5
	WORD $0x4ea31e45 // orr.16b	v5, v18, v3
	WORD $0x4e2058a5 // cnt.16b	v5, v5
	WORD $0x6e2028a5 // uaddlp.8h	v5, v5
	WORD $0x6e6028a5 // uaddlp.4s	v5, v5
	WORD $0x6ea068a0 // uadalp.2d	v0, v5
