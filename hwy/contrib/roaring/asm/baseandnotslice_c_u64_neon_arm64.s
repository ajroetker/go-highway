...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/roaring/asm/baseandnotslice_c_u64_neon_arm64.c

TEXT ·andnotslice_c_u64_neon(SB), $0-32
	MOVD dst+0(FP), R0
	MOVD a+8(FP), R1
	MOVD b+16(FP), R2
...
BB0_4:
	...
	WORD $0x4e641c10 // bic.16b	v16, v0, v4
	WORD $0x4e651c31 // bic.16b	v17, v1, v5
	WORD $0xad3f4550 // stp	q16, q17, [x10, #-32]
	WORD $0x4e661c50 // bic.16b	v16, v2, v6
	WORD $0x4e671c60 // bic.16b	v0, v3, v7
