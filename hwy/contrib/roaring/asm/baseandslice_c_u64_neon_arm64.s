...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/roaring/asm/baseandslice_c_u64_neon_arm64.c

TEXT ·andslice_c_u64_neon(SB), $0-32
	MOVD dst+0(FP), R0
	MOVD a+8(FP), R1
	MOVD b+16(FP), R2
...
BB0_4:
	...
	WORD $0x4e211cb1 // and.16b	v17, v5, v1
	WORD $0xad3f4550 // stp	q16, q17, [x10, #-32]
	WORD $0x4e221cd0 // and.16b	v16, v6, v2
	WORD $0x4e231ce0 // and.16b	v0, v7, v3
