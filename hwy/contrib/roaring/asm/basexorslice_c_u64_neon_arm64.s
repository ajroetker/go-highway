...
// source: /Users/ajroetker/go/src/github.com/ajroetker/go-highway/hwy/contrib/roaring/asm/basexorslice_c_u64_neon_arm64.c

TEXT ·xorslice_c_u64_neon(SB), $0-32
	MOVD dst+0(FP), R0
	MOVD a+8(FP), R1
	MOVD b+16(FP), R2
...
BB0_4:
	...
	WORD $0x6e201c90 // eor.16b	v16, v4, v0
	WORD $0x6e211cb1 // eor.16b	v17, v5, v1
	WORD $0xad3f4550 // stp	q16, q17, [x10, #-32]
	WORD $0x6e221cd0 // eor.16b	v16, v6, v2
	WORD $0x6e231ce0 // eor.16b	v0, v7, v3
